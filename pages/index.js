        ...
        <div>
                ...
                <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                  ...
                  <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                    ...
                    <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                      ...
                      <a href={profile.github} className="pl-4">
            ...
            <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
              <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                  I'm Harsh Dhoke, a Software Development Engineer
                </h4>
                <p className="pt-6 font-body leading-relaxed text-grey-20">
                  Hey there, first of all I welcome you on my website, now
                  talking about my educational background I am currently pusuing
                  my Bachelors of Technology degree in Computer Science and
                  Engineering. I have been very passionate for programming since
                  the first year of my degree. I have worked on different
                  projects in different domains like Web Development, Machine
                  Learning, etc. in the same period. The subjects which
                  intersets me a lot includes Data Structures and Algorithms
                  (DSA), Operating Systems, Database Management Systems,
                  Computer Networks, and System Design. I have solved nearly
                  250+ problems of DSA on different platforms in C++ programming
                  language. Using my skills I can take your projects to next
                  level. Feel free to connect Thankyou!!!
                </p>
                <div className="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                  ...
                  <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                    <a href={profile.linkedIN} className="pl-4">
                      <i className="bx bxl-linkedin-square text-3xl text-purple hover:text-yellow"></i>
                    </a>
                    <a href={profile.twitter} className="pl-4">
                      <i className="bx bxl-twitter text-3xl text-purple hover:text-yellow"></i>
                    </a>
                    <a href={profile.github} className="pl-4">
                      <i className="bx bxl-github text-3xl text-purple hover:text-yellow"></i>
                    </a>
                    <a href={profile.fbLink} className="pl-4">
                      <i className="bx bxl-facebook-square text-3xl text-purple hover:text-yellow"></i>
                    </a>
                    <a href={profile.instagram} className="pl-4">
                      <i className="bx bxl-instagram text-3xl text-purple hover:text-yellow"></i>
                    </a>
                  </div>
                </div>
              </div>
              <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
                <div>
                  <div className="flex items-end justify-between">
                    <h5 className="font-body font-semibold uppercase text-black">
                      Programming in C++
                    </h5>
                  ...
                  <div className="mt-1 h-2 w-full rounded-full bg-lila">
                    <div
                ...
                <div className="pt-6">
                  <div className="flex items-end justify-between">
                    <h5 className="font-body font-semibold uppercase text-black">
                      HTML | CSS | JAVASCRIPT | NextJS | ReactJS | Full Stack
          ...
          <div className="container py-16 md:py-20" id="services">
            ...
            <h3 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
              These are the Technologies and Skills I have mastered
            </h3>
            ...
            <div className="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
              <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                ...
                <div className="text-center">
                  ...
                  <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                    Solved 250+ problems on different platforms using C++,
                    studied 80% DSA till date.
                  </p>
                </div>
              </div>
              <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                ...
                <div className="text-center">
                  ...
                  <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                    Created fully responsive websites using MERN stack and
              ...
              <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                ...
                <div className="text-center">
                  ...
                  <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                    Worked on different machine learning models utilizing full
              ...
              <div className="group rounded px-8 py-12 shadow hover:bg-primary">
                ...
                <div className="text-center">
                  ...
                  <p className="text-grey pt-4 text-sm group-hover:text-white md:text-base">
                    Having great interest in writting technical blogs.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container py-16 md:py-20" id="portfolio">
            ...
            <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
              ...
              >
                <img
                  src="/assets/img/portfolio-portfolio.JPG"
              ...
              >
                <img
                  src="/assets/img/portfolio-signLanguage.JPG"
                  className="w-full shadow"
                  alt="portfolio image"
                />
              </a>
              ...
              <div className="mx-auto w-full sm:w-3/4 lg:w-full">
                ...
                <div className="flex flex-wrap items-center justify-center pt-4 sm:pt-4">
                  <span className="m-10 block">
                    <img
                      src="/assets/img/logo-persistent.PNG"
                      alt="client logo"
                  ...
                  <span className="m-10 block">
                    <img
                      src="/assets/img/logo-sparks-foundation.PNG"
                      alt="client logo"
                      className="mx-auto block h-20 w-auto"
                    />
                  </span>
                      ...
                      <div className="md:-mt-1 md:pl-8">
                        ...
                        <div className="pt-2">
                          <span className="block font-body text-black">
                            Working as a Salesforce Developer intern at
                            persistent systems. Managing and developing software
                            at Salesforce CRM platform. Effectively contributing
                            in increasing the company’s workflow by 14 percent.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative flex md:pl-18">
                    ...
                    <div className="mt-1 flex">
                      ...
                      <div className="md:-mt-1 md:pl-8">
                        ...
                        <div className="pt-2">
                          <span className="block font-body text-black">
                            Worked as an Data Analyst Intern. Managed and
                            Analyzed data flows using Python and its libraries.
                            Effectively contributed in increasing the company’s
                            workflow by 9 percent.
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container py-16 md:py-20" id="contact">
            ...
            <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
              <p className="font-body text-grey-10">
                Shoot it here and let's connect
              </p>
            </div>
            <form
            ...
            >
              ...
              <textarea
                ...
                rows="10"
              ></textarea>
              <button className="mt-6 flex items-center justify-center rounded bg-primary px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-grey-20" id="btn">
                Send
            ...
            <div className="flex flex-col pt-16 lg:flex-row">
              ...
              <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
                ...
                <p className="pt-2 text-left font-body font-bold text-primary lg:text-lg">
                  8th Mile, Davlameti, Nagpur, Maharashtra, India-440023.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            style={{ backgroundImage: "url(/assets/img/mymap.png)" }}
          ></div>
